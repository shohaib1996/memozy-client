      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <motion.h2
            ...
            className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 bg-gradient-to-r from-violet-600 via-blue-600 to-purple-600 dark:from-violet-400 dark:via-blue-400 dark:to-purple-400 bg-clip-text text-transparent leading-tight"
          >
