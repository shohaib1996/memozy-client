...
import { Brain, Instagram, Music2, Mail } from "lucide-react"
import qrCodeAll from "../../../public/qrcode-all.png"

export function Footer() {
  const quickLinks = [
    { name: "How to Use", href: "https://memozy.ai/how-to-use-memozy.html" },
    { name: "Second Brain", href: "https://www.memozy.ai/memozy_second_brain.html" },
  ...
  const socialLinks = [
    { name: "Instagram", icon: Instagram, href: "https://www.instagram.com/memozy_ai/" },
          ...
          >
            <Link href="/" className="flex items-center gap-2 group">
              <div className="relative">
                <Brain className="w-8 h-8 text-violet-500 group-hover:text-violet-400 transition-colors" />
                <motion.div
                  animate={{
                    scale: [1, 1.2, 1],
                    opacity: [0.5, 0.8, 0.5],
